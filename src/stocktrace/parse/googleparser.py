...
def parseMarket():
    ...
    page = parse('http://www.google.com.hk/finance/stockscreener?gl=cn#c0=QuoteLast&min0=3&max0=4&region=cn&sector=AllSectors&exchange=SHA_A&sort=&sortOrder=').getroot()
