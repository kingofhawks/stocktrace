...
urlpatterns = patterns('',
    # Examples:
    url(r'^$', 'zytj.views.ascendinglist', name='index'),
    ...
    url(r'^zytj/nhnl', 'zytj.views.nhnl', name='zytj.nhnl'),
    #MA Index
    url(r'^zytj/ma', 'zytj.views.ma', name='zytj.ma'),
    ...
    url(r'^zytj/alist', 'zytj.views.ascendinglist', name='zytj.alist'),  #asc from year low
    url(r'^zytj/dlist', 'zytj.views.descendinglist', name='zytj.dlist'), #des from year high
